...
#GUI Variables
$FormTitleText = "જિમ ટાઇલર (PowerShellEngineer.com) દ્વારા ડિસ્ક ક્લીનર"
$SelectDiskLabelText = "ડિસ્ક પસંદ કરો:"
$FreeSpaceLabelText = "ફ્રી સ્પેસ (ગીગાબાઇટ્સ): "
$TotalSpaceLabelText = "કુલ જગ્યા (ગીગાબાઇટ્સ): "
$JunkFoundLabelText = "જંક મળી (ગીગાબાઇટ્સ):"
$CleanDiskBtnText = "ડિસ્ક સાફ કરો *ફાઈલો કાઢી નાખો*"
$SpaceCleanedLabelText = "સાફ કરેલી જગ્યા (ગીગાબાઇટ્સ): "
$LogFileLabelText = "લોગ ફાઇલ મળી: $abcdefg"
$CreditLabelText = "જીમ ટાઇલર દ્વારા સ્ક્રિપ્ટ - PowerShellEngineer.com"
$LogFileLocatedText = "લોગ ફાઇલ મળી"
$AnalyzingDriveText = "ડ્રાઇવનું વિશ્લેષણ કરી રહ્યું છે..."
$BrowsersAreRunningText = "બ્રાઉઝર્સ ચાલી રહ્યા છે... વપરાશકર્તાને સૂચિત કરો..."
$PleaseCloseBrowsersText = "કૃપા કરીને બધા વેબ બ્રાઉઝર્સ બંધ કરો અને ફરી પ્રયાસ કરો."
$CleaningDriveText = "ડ્રાઇવની સફાઈ..."
